...
defined('EMAIL_TEMPLATE')				OR define('EMAIL_TEMPLATE', 'email_template'); //Table Name
defined('EMAIL_TEMPLATE_ID')			OR define('EMAIL_TEMPLATE_ID', 'template_id');
defined('EMAIL_TEMPLATE_NAME')			OR define('EMAIL_TEMPLATE_NAME', 'template_name');
defined('EMAIL_TEMPLATE_DESCRIPTION')	OR define('EMAIL_TEMPLATE_DESCRIPTION', 'template_description');
defined('EMAIL_TEMPLATE_SUBJECT')		OR define('EMAIL_TEMPLATE_SUBJECT', 'template_subject');
defined('EMAIL_TEMPLATE_BODY')			OR define('EMAIL_TEMPLATE_BODY', 'template_body');
