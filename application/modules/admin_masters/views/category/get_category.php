                    	...
                    	<div class="col-md-12">
                    		...
                    		<div class="card  card-box">
                    			...
                    			<div class="card-body ">
                    				...
                    				<a href="<?php echo base_url('admin_masters/category/create_category');?>"><button type="button" class="btn btn-success"><i class="fa fa-plus"></i>  Create New Category </button></a>
                                         	...
                                         	<?php $i=1; foreach($categories as $category): ?>
                                         		...
                                         		<tr class="odd gradeX">
                                                    <td><?= $i++;?></td>
                                         			...
                                         			<td>
                                         				<a href="<?php echo base_url('admin_masters/category/update_category/').$category->{CATEGORY_ID};?>" class="btn btn-success btn-tbl-edit btn-xs">
