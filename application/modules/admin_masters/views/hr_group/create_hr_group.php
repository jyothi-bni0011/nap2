	...
	<div class="col-md-12 col-sm-12">
		...
		<div class="card card-box">
			<div class="card-body" id="bar-parent">
				<form id="create_hr_group" method="POST" action="<?php echo base_url('admin_masters/hr_group/create_hr_group'); ?>" class="form-horizontal" autocomplete="off">
					<div class="form-body">
						...
						<div class="form-group row">
							...
							<div class="col-md-5">
								<input type="text" name="group_name" data-required="1" placeholder="Enter Group Name" class="form-control input-height" value="<?php echo set_value('group_name'); ?>">
							</div>
						</div>
						...
						<div class="form-group row">
							...
							<div class="col-md-5">
								<textarea class="form-control" name="group_description" rows="3" placeholder="Enter Group Description"><?php echo set_value('Group_description'); ?></textarea>
							</div>
						</div>
							...
							<div class="col-md-5">
								<select name="functional_area" class="form-control input-height" id="functional_area">
									...
									<?php foreach($functional_areas as $functional_area): ?>
			                           <option value="<?php echo $functional_area->{FUNCTIONAL_AREA_ID}; ?>"> <?php echo $functional_area->{FUNCTIONAL_AREA_NAME}; ?> </option>
		                       		<?php endforeach; ?>
								</select> 
							</div>
						</div>
