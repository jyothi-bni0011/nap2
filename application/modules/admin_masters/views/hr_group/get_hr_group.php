...
<div class="row">
	<div class="col-md-12">
		<div class="card  card-box">
			<div class="card-body ">
				<a href="<?php echo base_url('admin_masters/hr_group/create_hr_group');?>"><button type="button" class="btn btn-success"><i class="fa fa-plus"></i>  Create New HR Group </button></a>
...
<script>
	...
	$(document).ready(function(){
		...
		$('.category_id').on('click', function(){
			...
			$.ajax({
				type: "POST",
				url: '<?php echo base_url('admin_masters/hr_group/delete_hr_group');?>',
				data: {group_id:id},
				success:function(data) {
					console.log(data);
					if(data.success == "1") {
						window.location.href = "<?php echo base_url('admin_masters/hr_group'); ?>";
					}
				},
				error:function()
				{
