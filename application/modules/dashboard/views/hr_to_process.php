                    			...
                    			<div class="card-body ">
                    				...
                    				<div class="table-scrollable">
                    					<table id="tableExport" class="display table table-hover table-checkable order-column m-t-20" style="width: 100%">
                                         ...
                                         <tbody>
                                         	<?php if( ! empty($hr_to_process) ): ?>
                                                <?php $i=1; foreach ($hr_to_process as $associate): ?>
                                                <tr>
                                                    ...
                                                    <td class="text-center">
                                                        <?php if( $associate->status == 3 ): ?>
                                                            <a href="<?php echo base_url('new_associate/documents/' . $associate->user_id . '?r=view' ); ?>" class="btn bg-danger p-2 btn-circle"><i class="fa fa-file-pdf-o" aria-hidden="true"></i></a>
                                                        <?php endif; ?>
                                                    </td>
                                                </tr>
                                                <?php endforeach; ?>
