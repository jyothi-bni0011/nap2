                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-center">
                                                        <?php if( $associate->status == 4 ): ?>
                                                            <a href="<?php echo base_url('new_associate/view_all_document/' . $associate->user_id); ?>" class="btn bg-danger p-2 btn-circle"><i class="fa fa-file-pdf-o" aria-hidden="true"></i></a>
                                                        <?php endif; ?>
                                                    </td>
                                                </tr>
                                                <?php endforeach; ?>
