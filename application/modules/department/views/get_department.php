		...
		<div class="page-bar">
                    	...
                    	<div class="col-md-12">
                    		...
                    		<div class="card  card-box">
                    			...
                    			<div class="card-body ">
                    				...
                    				<a href="<?php echo base_url('department/createdepartment');?>"><button type="button" class="btn btn-success"><i class="fa fa-plus"></i>  Create New Department </button></a>
                                         ...
                                         <tbody>
                                         	<?php $i=1; foreach($departments as $department): ?>
                                         		...
                                         		<tr class="odd gradeX">
                                                    ...
                                                    <td><?php echo $department->{FUNCTIONAL_AREA_NAME}; ?></td>
                                         			<td>
                                         				<a href="<?php echo base_url('department/updatedepartment/index/').$department->{DEPARTMENT_ID};?>" class="btn btn-success btn-tbl-edit btn-xs">
                                         					<i class="fa fa-pencil"></i>
                                         				</a>
                                     					<button class="btn btn-tbl-delete btn-circle del_department" data-department_id="<?php echo $department->{DEPARTMENT_ID}; ?>" >
         ...
         <div class="modal fade" id="delete_role" tabindex="-1" role="dialog">
         	<div class="modal-dialog modal-dialog-centered" role="document">
         		<div class="modal-content">
         			...
         			<div class="modal-footer">
         				<button type="button" class="btn btn-secondary" data-dismiss="modal">Cancel</button>
         				<button type="button" class="btn btn-danger department_id" data-id="">Delete</button>
         			</div>
         		</div>
         	</div>
         </div>
         ...
         <script type="text/javascript" >
         	...
         	$(document).ready(function(){
         		...
         		$('.del_department').on('click', function(){
         			
         			var id = $(this).attr('data-department_id');
         			
         			$('#delete_role').modal('show');

         			$('.department_id').attr('data-id', id);
         		});
         		...
         		$('.department_id').on('click', function(){
         			...
         			$.ajax({
         				...
         				success:function(data) {
         					console.log(data);
         					if(data.success == "1") {
         						window.location.href = "<?php echo base_url('department/getdepartment'); ?>";
         					}
         				},
         				error:function()
         				{
