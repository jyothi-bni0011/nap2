				...
				<div class="table-scrollable">
					<table class="display table table-hover table-checkable order-column m-t-20" style="width: 100%">
                        ...
                        <tbody>
                            ...
                            <tr>
								<td><input type="checkbox" name="user_ids[]" value="<?= $document->user_id; ?>" form="modal-form"></td>
                                ...
                                <td class="text-center">
                                    <?php if( $document->status == 4 ): ?>
                                        <a href="<?php echo base_url('new_associate/documents/' . $document->user_id ); ?>" class="btn bg-danger p-2 btn-circle"><i class="fa fa-file-pdf-o" aria-hidden="true"></i></a>
                                    <?php endif; ?>
                                </td>
							</tr>
							<?php endforeach; ?>
