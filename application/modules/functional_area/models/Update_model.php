...
class Update_model extends MY_Model {
	...
	public function update( $fun_area_name, $fun_area_description="", $org_unit, $fun_area_id )
	{
		
		if( empty($fun_area_name) || empty($fun_area_description) || empty($fun_area_id) || empty($org_unit) ) {
			return false;
		}
