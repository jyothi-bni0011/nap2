        ...
        <form action="<?php echo base_url('document/assign_document') ?>" method="post" id="create_associate" class="form-horizontal" autocomplete="off">
                   <div class="form-body">
                         <div class="form-group row">
                              ...
                              <div class="col-md-5">
                                   <input type="text" name="username" id="username" data-required="1" placeholder="Enter Username" class="form-control input-height check_unique" data-msg-required="Username is required."/> 
								</div>
                         ...
                         <div class="form-group row">
                           ...
                           <div class="col-md-5">
                                <input type="text" name="email" id="email" data-required="1" placeholder="Enter Email ID" class="form-control input-height check_unique" data-msg-required="Email is required."/> 
                           </div>
                          ...
                          <div class="form-group row">
                              <label class="control-label col-md-3">First Name <span class="required"> * </span></label>
                                <div class="col-md-5">
                                    <input type="text" name="first_name" id="first_name" data-required="1" placeholder="Enter First Name" class="form-control input-height" data-msg-required="First Name is required."/> 
                                </div>
                          </div>
                          <div class="form-group row">
                          ...
                          <div class="form-group row">
                            ...
                            <div class="col-md-5">
                                <input type="text" name="last_name" id="last_name" data-required="1" placeholder="Enter Last Name" class="form-control input-height" data-msg-required="Last Name is required."/>
                            </div>
                          </div>
                          ...
                          <div class="form-group row">
                           ...
                           <div class="col-md-5">
                                <select class="form-control input-height hierarchy" name="functional_area" id="functional_area" data-msg-required="Functional Unit is required.">
                        ...
                        <div class="form-group row">
                         ...
                         <div class="form-group row">
                            ...
                            <div class="input-group date form_date col-md-5" data-date="" data-date-format="yyyy-dd-mm" data-link-field="dtp_input1" style="flex-wrap: nowrap;">
                                 <div class="col-md-12" style="padding: 0px;"><input class="form-control" size="16" type="text" id="start_date" name="start_date1" readonly data-msg-required="Start Date is required."></div>
						...
						<div class="form-group row" style="margin-top: -13px">
                            ...
                            <div class="col-md-5">   
                              <span id="start_date_error" style="color: red; display: none;">Start Date is required.</span>
                            </div>
