                    	...
                    	<div class="col-md-12">
                    		...
                    		<div class="card  card-box">
                    			...
                    			<div class="card-body ">
                    				...
                    				<a href="<?php echo base_url('category/createcategory');?>"><button type="button" class="btn btn-success"><i class="fa fa-plus"></i>  Create New Category </button></a>
                                         	...
                                         	<?php $i=1; foreach($categories as $category): ?>
                                         		...
                                         		<tr class="odd gradeX">
                                                    <td><?= $i++;?></td>
                                         			...
                                         			<td>
                                         				<a href="<?php echo base_url('category/updatecategory/index/').$category->{CATEGORY_ID};?>" class="btn btn-success btn-tbl-edit btn-xs">
                                         					<i class="fa fa-pencil"></i>
                                         				</a>
                                     					<button class="btn btn-tbl-delete btn-circle del_category" data-category_id="<?php echo $category->{CATEGORY_ID}; ?>" >
         		...
         		$('.category_id').on('click', function(){
         			...
         			$.ajax({
         				...
         				success:function(data) {
         					console.log(data);
         					if(data.success == "1") {
         						window.location.href = "<?php echo base_url('category/getcategory'); ?>";
         					}
         				},
         				error:function()
         				{
