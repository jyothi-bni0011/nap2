...
<div class="card card-box">
	<div class="card-head">
		<header>New Associate to Verify</header>
	</div>
...
<div class="card card-box">
	<div class="card-head">
		<header>New Associate Email Sent</header>
	</div>
	<div class="table-responsive">
		<table class="table display product-overview mb-30" id="support_table">
			<thead>
