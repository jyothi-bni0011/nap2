					...
					<table id="tableExport" class="display table table-hover table-checkable order-column m-t-20" style="width: 100%">
						...
						<tbody>
							...
							<tr class="odd gradeX">
								<td><?= $i++; ?></td>
								<td>
									<?php if( $associate_doc->status == 1 || $associate_doc->status == 0 ): ?>
										<a href="<?php echo base_url('document/generate/index/' . $associate_doc->{DOCUMENT_ID}); ?>"><?php echo $associate_doc->{DOCUMENT_TITLE}; ?></a>
									<?php else: ?>
								...
								<!-- <td> -->
									<!-- <?php //if( $associate_doc->status == 2 ): ?>
										<a href="<?php //echo base_url('document/generate/view/' . $associate_doc->{DOCUMENT_ID}); ?>" class="btn bg-danger p-2 btn-circle"><i class="fa fa-file-pdf-o" aria-hidden="true"></i></a>
									<?php //endif; ?> -->
								<!-- </td> -->
							</tr>
							<?php endforeach; ?>
