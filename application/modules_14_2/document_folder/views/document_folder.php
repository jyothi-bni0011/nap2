                    	...
                    	<div class="col-md-12">
                    		...
                    		<div class="card  card-box">
                    			...
                    			<div class="card-body ">
                    				...
                    				<a href="<?php echo base_url('document_folder/create');?>"><button type="button" class="btn btn-success"><i class="fa fa-plus"></i>  Create New Document Folder </button></a>
                    				...
                    				<div class="table-scrollable">
                    					<table id="tableExport" class="display table table-hover table-checkable order-column m-t-20" style="width: 100%">
                    						<thead>
                    							<tr>
                                                    <th>Sr No</th>
                    								<th width="25%"> Document Folder </th>
                    								<th> Document Folder Description  </th>
                                                 
                                                 <th> Action </th> 
                                             </tr>
                                         </thead>
                                         <tbody>
                                         	<?php $i=1; foreach($document_folders as $document_folder): ?>

                                         		<tr class="odd gradeX">
                                                    <td><?= $i++;?></td>
                                         			<td><?php echo $document_folder->{DOCUMENT_FOLDER_NAME}; ?></td>
                                         			<td><?php echo $document_folder->{DOCUMENT_FOLDER_DESCRIPTION}; ?></td>
                                         			<td>
                                         				<a href="<?php echo base_url('document_folder/update/index/').$document_folder->{DOCUMENT_FOLDER_ID};?>" class="btn btn-success btn-tbl-edit btn-xs">
                                         					<i class="fa fa-pencil"></i>
                                         				</a>
                                     					<button class="btn btn-tbl-delete btn-circle del_doc_folder" data-doc_folder_id="<?php echo $document_folder->{DOCUMENT_FOLDER_ID}; ?>" >
         ...
         <script type="text/javascript" >
         	...
         	$(document).ready(function(){
         		...
         		$('.doc_folder_id').on('click', function(){
         			...
         			$.ajax({
         				type: "POST",
         				url: '<?php echo base_url('document_folder/delete');?>',
         				data: {doc_folder_id:id},
         				success:function(data) {
         					console.log(data);
         					if(data.success == "1") {
         						window.location.href = "<?php echo base_url('document_folder'); ?>";
         					}
         				},
         				error:function()
         				{
