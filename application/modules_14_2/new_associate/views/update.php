          ...
          <input type="hidden" name="associate_id" value="<?php echo $associate_id ?>">
                   <div class="form-body">
                        ...
                        <div class="form-group row">
                           ...
                           <div class="col-md-5">
                                <select class="form-control input-height" name="manager_id" id="manager_id">
                                   <option value="">Select Manager </option>
                                    <?php foreach($hr_managers as $hr_manager): ?>
                                      
                                      <option value="<?php echo $hr_manager->{USER_ID}; ?>" <?php if($hr_manager->{USER_ID} == $manager) echo 'selected'; ?> > <?php echo $hr_manager->{USER_FIRST_NAME}.' '.$hr_manager->{USER_LAST_NAME}; ?> </option>
