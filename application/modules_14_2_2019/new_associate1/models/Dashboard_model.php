...
class Dashboard_model extends CI_Model {
	...
	public function associate_docs( $associate_id )
	{
		...
		$this->db->select('user_document_mapping.*, document.document_title, ( SELECT role_id FROM document_form_steps WHERE document_id = user_document_mapping.document_id AND form_step = user_document_mapping.form_step) as form_step_role_id', FALSE);
		$this->db->from( USER_DOCUMENT_MAPPING );
